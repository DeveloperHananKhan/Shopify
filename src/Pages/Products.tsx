  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  p-10  dark:bg-gray-800 rounded-lg p-4 ">
          {products.map((product) => (
            ...
            >
              ...
              <p className="text-gray-900 font-semibold dark:text-green-400 font-semibold">${product.price}</p>
    ...
    c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"
      ...
      <div className="flex justify-center gap-4 mt-5 mb-8 ">
        ...
        <span className="px-4 py-2 bg-gray-200 rounded dark:bg-gray-800 dark:text-white ">{page}</span>
